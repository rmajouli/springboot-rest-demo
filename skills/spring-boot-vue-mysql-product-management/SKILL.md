---
name: spring-boot-vue-mysql-product-management
description: Expert full-stack agent for building product management applications with Spring Boot, Vue.js, MySQL, JPA/Hibernate, REST APIs, validation, exception handling, Swagger, pagination, sorting, and automated tests.
---

# Spring Boot + Vue.js + MySQL Product Management

This skill provides expert guidance for creating and maintaining a full-stack product management application using Spring Boot, Vue.js, MySQL, JPA/Hibernate, and REST APIs.
...
Structure test coverage in this order:

1. happy path
2. alternative valid scenarios
3. edge cases
4. validation errors
5. exception and failure scenarios

Use AssertJ assertions for readable test failures.

## Frontend testing

When frontend tests are requested, use:
...
- form validation
- successful product creation
- delete confirmation and behavior
- pagination controls
- sorting controls
...
7. How to run the Spring Boot backend
...
2. Identify the current Spring Boot and Vue.js versions.
